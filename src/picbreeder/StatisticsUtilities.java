...
//		System.out.println(equalMaxIndexes.size());
		return equalMaxIndexes.get(RandomNumbers.randomGenerator.nextInt(equalMaxIndexes.size())); // Returns an Index containing the maxumim value
	}
...
//		System.out.println(equalMaxIndexes.size());
	...
	public static int argmax(int[] xs) {
		...
		return equalMaxIndexes.get(RandomNumbers.randomGenerator.nextInt(equalMaxIndexes.size()));
	}
	...
	public static int argmin(double[] xs) {
		...
		return equalMinIndexes.get(RandomNumbers.randomGenerator.nextInt(equalMinIndexes.size())); // Returns an Index that contains the minimum value
	}
